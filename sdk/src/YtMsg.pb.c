...
const pb_field_t YtRpc_fields[14] = {
    ...
    PB_ONEOF_FIELD(params,   3, STRING  , ONEOF, POINTER , OTHER, YtRpc, strParams, sequenceId, 0),
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(YtResult, data.faceDetectionResult) < 256 && pb_membersize(YtResult, data.systemStatusResult) < 256 && pb_membersize(YtRpc, params.cameraExposureParams) < 256 && pb_membersize(YtRpc, params.flasherParams) < 256 && pb_membersize(YtRpc, params.filePart) < 256 && pb_membersize(YtRpc, params.registerFaceIdWithPicParams) < 256 && pb_membersize(YtRpc, params.registerFaceIdFromCameraParams) < 256 && pb_membersize(YtRpc, params.setFaceIdParams) < 256 && pb_membersize(YtRpc, params.listFaceIdParams) < 256 && pb_membersize(YtRpc, params.registerFaceIdWithTraceIdParams) < 256 && pb_membersize(YtRpcResponse, data.fileListResult) < 256 && pb_membersize(YtRpcResponse, data.filePart) < 256 && pb_membersize(YtRpcResponse, data.faceIdListData) < 256 && pb_membersize(YtMsg, values.rpc) < 256 && pb_membersize(YtMsg, values.response) < 256 && pb_membersize(YtMsg, values.result) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_YtResult_YtRpc_YtRpcResponse_YtMsg)
#endif
