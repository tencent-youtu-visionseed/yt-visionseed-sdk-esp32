...
/* Generated by nanopb-0.3.9.2 at Fri Sep  6 14:27:17 2019. */
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Face, rect) < 65536 && pb_membersize(Face, shape) < 65536 && pb_membersize(Face, pose) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Rect_Pose_FaceShape_Face_FaceDetectionResult)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Face, rect) < 256 && pb_membersize(Face, shape) < 256 && pb_membersize(Face, pose) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Rect_Pose_FaceShape_Face_FaceDetectionResult)
#endif
